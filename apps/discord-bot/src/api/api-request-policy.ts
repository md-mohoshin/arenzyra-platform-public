...
const MIN_RESULT_WORKFLOW_API_REQUEST_TIMEOUT_MS = 120_000;
...
export function resultWorkflowApiRequestTimeoutMs(defaultTimeoutMs: number) {
  return Math.max(defaultTimeoutMs, MIN_RESULT_WORKFLOW_API_REQUEST_TIMEOUT_MS);
}
